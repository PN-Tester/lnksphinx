...
def create_lnk(target_file, out_file, icon_index=None, args=None):
    ...
    Blob3 = (
        ""
    )
    iconHex = (
    ...
    bigBlob = Blob1 + header + Blob2 + (icon_index if icon_index else "00") + Blob3
...
def main():
    ...
    create_lnk(args.target_file, args.out_file, icon_index=args.icon, args=args.args)
